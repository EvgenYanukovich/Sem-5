...
--
-- Host: localhost    Database: basemysql_yan
-- ------------------------------------------------------
...
--
-- Table structure for table `deleted_technics`
--

DROP TABLE IF EXISTS `deleted_technics`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `deleted_technics` (
  `Название_техники` varchar(100) DEFAULT NULL,
  `Часть_удалённая` int DEFAULT NULL,
  `Характеристики_удалённые` varchar(1000) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `deleted_technics`
--

LOCK TABLES `deleted_technics` WRITE;
/*!40000 ALTER TABLE `deleted_technics` DISABLE KEYS */;
INSERT INTO `deleted_technics` VALUES ('БТР-80',1,'8-колёсный бронетранспортёр'),('БТР-80',1,'100');
/*!40000 ALTER TABLE `deleted_technics` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `partswithtroops`
--

DROP TABLE IF EXISTS `partswithtroops`;
/*!50001 DROP VIEW IF EXISTS `partswithtroops`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `partswithtroops` AS SELECT 
 1 AS `Военнослужащий`,
 1 AS `Имя`,
 1 AS `Часть`,
 1 AS `Вид_войск`*/;
...
--
-- Table structure for table `виды_войск`
--

DROP TABLE IF EXISTS `виды_войск`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `виды_войск`
--

LOCK TABLES `виды_войск` WRITE;
/*!40000 ALTER TABLE `виды_войск` DISABLE KEYS */;
INSERT INTO `виды_войск` VALUES (1,'Пехота',5),(2,'Танковые войска',3),(3,'Артиллерия',4);
/*!40000 ALTER TABLE `виды_войск` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `военнослужащие`
--

DROP TABLE IF EXISTS `военнослужащие`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `военнослужащие` (
  ...
  `Часть` int DEFAULT NULL,
  `Вид_войск` int DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `Вид_войск` (`Вид_войск`),
  KEY `fk_части` (`Часть`),
  CONSTRAINT `fk_части` FOREIGN KEY (`Часть`) REFERENCES `части` (`ID`),
  CONSTRAINT `военнослужащие_ibfk_2` FOREIGN KEY (`Вид_войск`) REFERENCES `виды_войск` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `военнослужащие`
--

LOCK TABLES `военнослужащие` WRITE;
/*!40000 ALTER TABLE `военнослужащие` DISABLE KEYS */;
INSERT INTO `военнослужащие` VALUES (1,'Иванов','Алексей',1,1),(2,'Сидоров','Борис',2,2),(3,'Петров','Владимир',3,3),(4,'Кузнецов','Игорь',1,2),(5,'Мальков','Георгий',3,2),(6,'Мальков','Георгий',3,2);
/*!40000 ALTER TABLE `военнослужащие` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `вооружение`
--

DROP TABLE IF EXISTS `вооружение`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `вооружение` (
  ...
  `Название` varchar(100) NOT NULL,
  `Часть` int DEFAULT NULL,
  `Характеристики` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `Часть` (`Часть`),
  CONSTRAINT `вооружение_ibfk_1` FOREIGN KEY (`Часть`) REFERENCES `части` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `вооружение`
--

LOCK TABLES `вооружение` WRITE;
/*!40000 ALTER TABLE `вооружение` DISABLE KEYS */;
INSERT INTO `вооружение` VALUES (1,'Автомат АК-47',1,'Калибр 7.62 мм, магазин на 30 патронов'),(2,'Пистолет Макарова',2,'Калибр 9 мм'),(3,'Гранатомёт РПГ-7',3,'Противотанковое оружие');
/*!40000 ALTER TABLE `вооружение` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `техника`
--

DROP TABLE IF EXISTS `техника`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `техника` (
  ...
  PRIMARY KEY (`ID`),
  KEY `Часть` (`Часть`),
  CONSTRAINT `техника_ibfk_1` FOREIGN KEY (`Часть`) REFERENCES `части` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `техника`
--

LOCK TABLES `техника` WRITE;
/*!40000 ALTER TABLE `техника` DISABLE KEYS */;
INSERT INTO `техника` VALUES (1,'Танк Т-90',2,'Броня усилена, калибр 125 мм'),(3,'Гаубица',3,'152-мм самоходная артиллерийская установка'),(6,'Гаубица',3,'150'),(7,'Гаубица',3,'150'),(8,'БТР-80',1,'100'),(9,'БТР-80',1,'100'),(10,'Гаубица',3,'150'),(11,'БТР-80',1,'100'),(12,'Гаубица',3,'150');
/*!40000 ALTER TABLE `техника` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `части`
--

DROP TABLE IF EXISTS `части`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `части` (
  `ID` int NOT NULL,
...
--
-- Dumping data for table `части`
--

LOCK TABLES `части` WRITE;
/*!40000 ALTER TABLE `части` DISABLE KEYS */;
INSERT INTO `части` VALUES (1,'Часть 1','Россия','Москва','ул. Ленина, 5',150.5,10),(2,'Часть 2','Беларусь','Минск','ул. Победы, 7',200,12),(3,'Часть 3','Казахстан','Алматы','ул. Абая, 8',180,8);
/*!40000 ALTER TABLE `части` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Final view structure for view `partswithtroops`
--
...
/*!50001 VIEW `partswithtroops` AS select `v`.`Фамилия` AS `Военнослужащий`,`v`.`Имя` AS `Имя`,`c`.`Название` AS `Часть`,`w`.`Название` AS `Вид_войск` from ((`военнослужащие` `v` join `части` `c` on((`v`.`Часть` = `c`.`ID`))) join `виды_войск` `w` on((`v`.`Вид_войск` = `w`.`ID`))) */;
...
-- Dump completed on 2024-11-22  8:11:54
-- MySQL dump 10.13  Distrib 8.0.38, for Win64 (x86_64)
--
...
CREATE TABLE `notifications` (
  `id` int NOT NULL AUTO_INCREMENT,
  `user_id` int NOT NULL,
  `type` enum('message','friend_request') NOT NULL,
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2024-10-04 05:12:46',NULL),('diagnostics.include_raw','OFF','2024-10-04 05:12:46',NULL),('ps_thread_trx_info.max_length','65535','2024-10-04 05:12:46',NULL),('statement_performance_analyzer.limit','100','2024-10-04 05:12:46',NULL),('statement_performance_analyzer.view',NULL,'2024-10-04 05:12:46',NULL),('statement_truncate_len','64','2024-10-04 05:12:46',NULL);
...
-- Dump completed on 2024-11-22  8:11:55
